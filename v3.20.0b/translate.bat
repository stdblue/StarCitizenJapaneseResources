...
julia ..\..\tools\split_replace.jl global.ini.momo ..\library\manual\jascom_translated.txt >global.ini.jascom

REM ぴにきさん翻訳分を適用
julia ..\..\tools\split_replace.jl global.ini.jascom ..\library\manual\mossy_1_message.txt ..\library\manual\mossy_2_message.txt ..\library\manual\mossy_3_message.txt>global.ini
